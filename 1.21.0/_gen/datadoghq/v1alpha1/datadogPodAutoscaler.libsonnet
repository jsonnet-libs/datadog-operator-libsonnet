{
  ...
  spec: {
    ...
    policy: {
      '#downscale':: d.obj(help='"Downscale defines the policy to scale down the target resource."'),
      downscale: {
      ...
      '#withApplyMode':: d.fn(help="\"ApplyMode determines recommendations that should be applied by the controller:\\n- All: Apply all recommendations (regular and manual).\\n- Manual: Apply only manual recommendations (recommendations manually validated by user in the Datadog app).\\n- None: Prevent the controller to apply any recommendations.\\nIt's also possible to selectively deactivate upscale, downscale or update actions thanks to the `Upscale`, `Downscale` and `Update` fields.\"", args=[d.arg(name='applyMode', type=d.T.string)]),
      withApplyMode(applyMode): { spec+: { policy+: { applyMode: applyMode } } },
    },
    ...
    '#withRemoteVersion':: d.fn(help='"RemoteVersion is the version of the .Spec currently store in this object.\\nOnly set if the owner is Remote."', args=[d.arg(name='remoteVersion', type=d.T.integer)]),
    withRemoteVersion(remoteVersion): { spec+: { remoteVersion: remoteVersion } },
    '#withTargets':: d.fn(help='"Targets are objectives to reach and maintain for the target resource.\\nDefault to a single target to maintain 80% POD CPU utilization."', args=[d.arg(name='targets', type=d.T.array)]),
    withTargets(targets): { spec+: { targets: if std.isArray(v=targets) then targets else [targets] } },
    '#withTargetsMixin':: d.fn(help='"Targets are objectives to reach and maintain for the target resource.\\nDefault to a single target to maintain 80% POD CPU utilization."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='targets', type=d.T.array)]),
