---
permalink: /1.21.0/datadoghq/v1alpha1/datadogMetric/
---

# datadoghq.v1alpha1.datadogMetric
...
* [`obj spec`](#obj-spec)
  * [`fn withExternalMetricName(externalMetricName)`](#fn-specwithexternalmetricname)
  * [`fn withMaxAge(maxAge)`](#fn-specwithmaxage)
  * [`fn withQuery(query)`](#fn-specwithquery)
  * [`fn withTimeWindow(timeWindow)`](#fn-specwithtimewindow)
...
new returns an instance of DatadogMetric
...
### fn spec.withExternalMetricName

```ts
withExternalMetricName(externalMetricName)
```
