---
permalink: /1.21.0/datadoghq/v1alpha1/datadogPodAutoscaler/
---
...
* [`obj spec`](#obj-spec)
  ...
  * [`obj spec.targets`](#obj-spectargets)
    ...
    * [`obj spec.targets.customQuery`](#obj-spectargetscustomquery)
      * [`fn withWindow(window)`](#fn-spectargetscustomquerywithwindow)
      * [`obj spec.targets.customQuery.request`](#obj-spectargetscustomqueryrequest)
        * [`fn withFormula(formula)`](#fn-spectargetscustomqueryrequestwithformula)
        * [`fn withQueries(queries)`](#fn-spectargetscustomqueryrequestwithqueries)
        * [`fn withQueriesMixin(queries)`](#fn-spectargetscustomqueryrequestwithqueriesmixin)
        * [`obj spec.targets.customQuery.request.queries`](#obj-spectargetscustomqueryrequestqueries)
          * [`fn withName(name)`](#fn-spectargetscustomqueryrequestquerieswithname)
          * [`fn withSource(source)`](#fn-spectargetscustomqueryrequestquerieswithsource)
          * [`obj spec.targets.customQuery.request.queries.apmMetrics`](#obj-spectargetscustomqueryrequestqueriesapmmetrics)
            * [`fn withGroupBy(groupBy)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithgroupby)
            * [`fn withGroupByMixin(groupBy)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithgroupbymixin)
            * [`fn withOperationName(operationName)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithoperationname)
            * [`fn withQueryFilter(queryFilter)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithqueryfilter)
            * [`fn withResourceHash(resourceHash)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithresourcehash)
            * [`fn withResourceName(resourceName)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithresourcename)
            * [`fn withService(service)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithservice)
            * [`fn withSpanKind(spanKind)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithspankind)
            * [`fn withStat(stat)`](#fn-spectargetscustomqueryrequestqueriesapmmetricswithstat)
          * [`obj spec.targets.customQuery.request.queries.metrics`](#obj-spectargetscustomqueryrequestqueriesmetrics)
            * [`fn withQuery(query)`](#fn-spectargetscustomqueryrequestqueriesmetricswithquery)
      * [`obj spec.targets.customQuery.value`](#obj-spectargetscustomqueryvalue)
        * [`fn withAbsoluteValue(absoluteValue)`](#fn-spectargetscustomqueryvaluewithabsolutevalue)
        * [`fn withType(type)`](#fn-spectargetscustomqueryvaluewithtype)
        * [`fn withUtilization(utilization)`](#fn-spectargetscustomqueryvaluewithutilization)
...
## obj spec.targets.customQuery

"CustomQuery allows to set a controller-level objective."

### fn spec.targets.customQuery.withWindow
...
## obj spec.targets.customQuery.request

"Request is the timeseries query to use for the objective."

### fn spec.targets.customQuery.request.withFormula
...
### fn spec.targets.customQuery.request.withQueries
...
### fn spec.targets.customQuery.request.withQueriesMixin
...
## obj spec.targets.customQuery.request.queries

"Queries is a list of timeseries queries to use for the objective.\nAt least one query must be specified"

### fn spec.targets.customQuery.request.queries.withName
...
### fn spec.targets.customQuery.request.queries.withSource
...
## obj spec.targets.customQuery.request.queries.apmMetrics

"ApmMetrics is allows to query APM metrics."

### fn spec.targets.customQuery.request.queries.apmMetrics.withGroupBy
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withGroupByMixin
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withOperationName
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withQueryFilter
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withResourceHash
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withResourceName
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withService
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withSpanKind
...
### fn spec.targets.customQuery.request.queries.apmMetrics.withStat
...
## obj spec.targets.customQuery.request.queries.metrics

"Metrics is a standard Datadog metrics query."

### fn spec.targets.customQuery.request.queries.metrics.withQuery
...
## obj spec.targets.customQuery.value

"Value is the value of the objective"

### fn spec.targets.customQuery.value.withAbsoluteValue
...
### fn spec.targets.customQuery.value.withType
...
### fn spec.targets.customQuery.value.withUtilization
