---
permalink: /1.21.0/datadoghq/v1alpha1/datadogAgentProfile/
---
  ...
  * [`obj spec.config`](#obj-specconfig)
    ...
    * [`obj spec.config.features`](#obj-specconfigfeatures)
      ...
      * [`obj spec.config.features.autoscaling`](#obj-specconfigfeaturesautoscaling)
        * [`obj spec.config.features.autoscaling.cluster`](#obj-specconfigfeaturesautoscalingcluster)
          * [`fn withEnabled(enabled)`](#fn-specconfigfeaturesautoscalingclusterwithenabled)
      ...
      * [`obj spec.config.features.kubeStateMetricsCore`](#obj-specconfigfeatureskubestatemetricscore)
        * [`fn withCollectCrMetrics(collectCrMetrics)`](#fn-specconfigfeatureskubestatemetricscorewithcollectcrmetrics)
        * [`fn withCollectCrMetricsMixin(collectCrMetrics)`](#fn-specconfigfeatureskubestatemetricscorewithcollectcrmetricsmixin)
        * [`fn withEnabled(enabled)`](#fn-specconfigfeatureskubestatemetricscorewithenabled)
        * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetrics)
          * [`fn withCommonLabels(commonLabels)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithcommonlabels)
          * [`fn withCommonLabelsMixin(commonLabels)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithcommonlabelsmixin)
          * [`fn withLabelsFromPath(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithlabelsfrompath)
          * [`fn withLabelsFromPathMixin(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithlabelsfrompathmixin)
          * [`fn withMetricNamePrefix(metricNamePrefix)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithmetricnameprefix)
          * [`fn withMetrics(metrics)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithmetrics)
          * [`fn withMetricsMixin(metrics)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithmetricsmixin)
          * [`fn withResourcePlural(resourcePlural)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricswithresourceplural)
          * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.groupVersionKind`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsgroupversionkind)
            * [`fn withGroup(group)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsgroupversionkindwithgroup)
            * [`fn withKind(kind)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsgroupversionkindwithkind)
            * [`fn withVersion(version)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsgroupversionkindwithversion)
          * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsmetrics)
            * [`fn withCommonLabels(commonLabels)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithcommonlabels)
            * [`fn withCommonLabelsMixin(commonLabels)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithcommonlabelsmixin)
            * [`fn withHelp(help)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithhelp)
            * [`fn withLabelsFromPath(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithlabelsfrompath)
            * [`fn withLabelsFromPathMixin(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithlabelsfrompathmixin)
            * [`fn withName(name)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricswithname)
            * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseach)
              * [`fn withType(type)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachwithtype)
              * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgauge)
                * [`fn withLabelFromKey(labelFromKey)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithlabelfromkey)
                * [`fn withLabelsFromPath(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithlabelsfrompath)
                * [`fn withLabelsFromPathMixin(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithlabelsfrompathmixin)
                * [`fn withNilIsZero(nilIsZero)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithniliszero)
                * [`fn withPath(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithpath)
                * [`fn withPathMixin(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithpathmixin)
                * [`fn withValueFrom(valueFrom)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithvaluefrom)
                * [`fn withValueFromMixin(valueFrom)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachgaugewithvaluefrommixin)
              * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfo)
                * [`fn withLabelFromKey(labelFromKey)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfowithlabelfromkey)
                * [`fn withLabelsFromPath(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfowithlabelsfrompath)
                * [`fn withLabelsFromPathMixin(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfowithlabelsfrompathmixin)
                * [`fn withPath(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfowithpath)
                * [`fn withPathMixin(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachinfowithpathmixin)
              * [`obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet`](#obj-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstateset)
                * [`fn withLabelName(labelName)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithlabelname)
                * [`fn withLabelsFromPath(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithlabelsfrompath)
                * [`fn withLabelsFromPathMixin(labelsFromPath)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithlabelsfrompathmixin)
                * [`fn withList(list)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithlist)
                * [`fn withListMixin(list)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithlistmixin)
                * [`fn withPath(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithpath)
                * [`fn withPathMixin(path)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithpathmixin)
                * [`fn withValueFrom(valueFrom)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithvaluefrom)
                * [`fn withValueFromMixin(valueFrom)`](#fn-specconfigfeatureskubestatemetricscorecollectcrmetricsmetricseachstatesetwithvaluefrommixin)
...
## obj spec.config.features.autoscaling.cluster

"Cluster contains the configuration for the cluster autoscaling product."

### fn spec.config.features.autoscaling.cluster.withEnabled
...
### fn spec.config.features.kubeStateMetricsCore.withCollectCrMetrics

```ts
withCollectCrMetrics(collectCrMetrics)
```
...
### fn spec.config.features.kubeStateMetricsCore.withCollectCrMetricsMixin

```ts
withCollectCrMetricsMixin(collectCrMetrics)
```
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics

"`CollectCrMetrics` defines custom resources for the kube-state-metrics core check to collect.\n\nThe datadog agent uses the same logic as upstream `kube-state-metrics`. So is its configuration.\nThe exact structure and existing fields of each item in this list can be found in:\nhttps://github.com/kubernetes/kube-state-metrics/blob/main/docs/metrics/extend/customresourcestate-metrics.md"

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withCommonLabels
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withCommonLabelsMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withLabelsFromPath

```ts
withLabelsFromPath(labelsFromPath)
```

"LabelsFromPath adds additional labels where the value is taken from a field in the resource."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withLabelsFromPathMixin

```ts
withLabelsFromPathMixin(labelsFromPath)
```
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withMetricNamePrefix

```ts
withMetricNamePrefix(metricNamePrefix)
```
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withMetrics
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withMetricsMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.withResourcePlural

```ts
withResourcePlural(resourcePlural)
```
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.groupVersionKind

"GroupVersionKind of the custom resource to be monitored."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.groupVersionKind.withGroup
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.groupVersionKind.withKind
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.groupVersionKind.withVersion
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics

"Metrics are the custom resource fields to be collected."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withCommonLabels
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withCommonLabelsMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withHelp
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withLabelsFromPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withLabelsFromPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.withName
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each

"Each targets a value or values from the resource."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.withType
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge

"Gauge defines a gauge metric."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withLabelFromKey

```ts
withLabelFromKey(labelFromKey)
```

"LabelFromKey adds a label with the given name if Path is an object. The label value will be the object key."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withLabelsFromPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withLabelsFromPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withNilIsZero

```ts
withNilIsZero(nilIsZero)
```

"NilIsZero indicates that if a value is nil it will be treated as zero value."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withValueFrom
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.gauge.withValueFromMixin
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info

"Info defines an info metric."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info.withLabelFromKey
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info.withLabelsFromPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info.withLabelsFromPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info.withPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.info.withPathMixin
...
## obj spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet

"StateSet defines a state set metric."

### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withLabelName
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withLabelsFromPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withLabelsFromPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withList
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withListMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withPath
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withPathMixin
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withValueFrom
...
### fn spec.config.features.kubeStateMetricsCore.collectCrMetrics.metrics.each.stateSet.withValueFromMixin
