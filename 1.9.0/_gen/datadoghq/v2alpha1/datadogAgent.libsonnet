  ...
  spec: {
    ...
    features: {
      ...
      apm: {
        ...
        hostPortConfig: {
          '#withEnabled':: d.fn(help='"Enabled enables host port configuration\\nDefault: false"', args=[d.arg(name='enabled', type=d.T.boolean)]),
